...
public void mostrar1(String guar)
{
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(agua.AguaApp.class).getContext().getResourceMap(JDlgRegPagos.class);
...
//        totmeses=mesdos-mesuno;
        ...
        {
            costo=(float) (45.00 *1);
            recar=(float) (45.00 *1)*(float)0.03;
         ...
         else
         {
            ...
            costo=(float) (45.00 *totmeses);
            recar=(float) (45.00 *totmeses)*(float)0.03;
            numero = (int)(recar * 100);
            rec =(float)(numero/100.0);
            iva=(float)0+(float)0;
             total= costo+rec+iva;
       ...
       if(JTxtFechaCubierta.getText().equals(JTxtFechaaPagar.getText()) & JTxtTarifa.getText().equals("comercial"))
        {
             costo=(float) (200.00 *1);
            recar=(float) (200.00 *1)*(float)0;
            numero = (int)(recar * 100);
            rec =(float)(numero/100.0);
      ...
      this.JTxtRezagos.setText(Float.toString(costo));
       ...
       else
       {
           ...
           { if(JTxtFechaCubierta.getText()!=(JTxtFechaaPagar.getText()) & JTxtTarifa.getText().equals("comercial"))
            costo=(float) (200.00 *totmeses);
            recar=(float) (200.00 *totmeses)*(float)0.03;
            numero = (int)(recar * 100);
            rec =(float)(numero/100.0);
            iva=(float)0+(float).16;
             total= costo+rec+iva;
      ...
      if(JTxtFechaCubierta.getText().equals(JTxtFechaaPagar.getText()) & JTxtTarifa.getText().equals("industrial"))
        {
            costo=(float) (800.00 *totmeses);
            recar=(float) (800.00 *totmeses)*(float)0.03;
            numero = (int)(recar * 100);
            rec =(float)(numero/100.0);
            iva=(float)0+(float).16;
             total= costo+rec+iva;
      ...
      if(JTxtFechaCubierta.getText().equals(JTxtFechaaPagar.getText()) & JTxtTarifa.getText().equals("insen"))
        {
            costo=(float) (22.50 *1);
            recar=(float) (22.50 *1)*(float)0.03;
            numero = (int)(recar * 100);
             rec =(float)(numero/100.0);
             iva=(float)0+(float)0;
             total= costo+rec+iva;
         ...
         else
         {
            ...
            costo=(float) (22.50 *totmeses);
            recar=(float) (22.50 *totmeses)*(float)0.03;
            numero = (int)(recar * 100);
            rec =(float)(numero/100.0);
            iva=(float)0+(float)0;
             total= costo+rec+iva;
        ...
        {
            costo=(float) (1000.00 *1);
            recar=(float) (1000.00 *1)*(float)0.03;
            numero = (int)(recar * 100);
             rec =(float)(numero/100.0);
             iva=(float)0+(float)0;
             total= costo+rec+iva;
         ...
         else
         {
            ...
            costo=(float) (1000.00 *totmeses);
            recar=(float) (1000.00 *totmeses)*(float)0.03;
            numero = (int)(recar * 100);
            rec =(float)(numero/100.0);
            iva=(float)0+(float)0;
             total= costo+rec+iva;
...
JOptionPane.showMessageDialog( null, "REGISTRO DEL PAGO SE GUARDO CORRECTAMENTE", "GUARDANDO", JOptionPane.INFORMATION_MESSAGE);
            ...
            JOptionPane.showMessageDialog( null, "ERROR AL REGISTRAR EL PAGO", "VERIFICAR", JOptionPane.ERROR_MESSAGE);
        }
         }
 else
 {
...
JOptionPane.showMessageDialog( null, "REGISTRO DEL PAGO SE ACTUALIZO CORRECTAMENTE", "ACTUALIZANDO", JOptionPane.INFORMATION_MESSAGE);
            ...
            JOptionPane.showMessageDialog( null, "ERROR AL ACTUALIZAR EL PAGO", "VERIFICAR", JOptionPane.ERROR_MESSAGE);
        }
         }
    }
 }
