...
public void muestra()
 ...
 public void total()
 {
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(agua.AguaApp.class).getContext().getResourceMap(JDlgRepIngresos.class);
    ...
    private void JBtnImprimirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JBtnImprimirActionPerformed
        ...
        if(exportacionOk) {
            ...
            JOptionPane.showMessageDialog(this,"ERROR AL EXPORTAR LOS DATOS A EXCEL","VERIFICAR",JOptionPane.ERROR_MESSAGE);
        }
