...
public class JDlgBackup extends javax.swing.JDialog
{
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(agua.AguaApp.class).getContext().getResourceMap(JDlgBackup.class);
    ...
    Date calendario=new Date();
        ...
        else
        {
            try
            {
               ...
               File backupFile = new File(String.valueOf(jFileChooser1.getCurrentDirectory()) + "\\dbagua" + dateformat.format(calendario.getTime()) + ".sql");
                           
                FileWriter fw = new FileWriter(backupFile);
               Process child = runtime.exec("C:\\Archivos de programa\\MySQL\\MySQL Server 5.0\\bin\\mysqldump --opt --password= --user=root dbagua");
