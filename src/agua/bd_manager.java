...
public class bd_manager {
    ...
    public void AbcProye(String Consulta) throws Exception
    {
        ...
        {
            JOptionPane.showMessageDialog(null, "ERROR DE ACTUALIZACION", "Agua", JOptionPane.INFORMATION_MESSAGE);
        }
            conn.close();
            St.close();
    }
    ...
    public String BuscaEva(String sQl) throws Exception
    {
        ...
        {
            JOptionPane.showMessageDialog(null, "NO EXISTE INFORMACION", "Agua", JOptionPane.INFORMATION_MESSAGE);
        }
        return x;
    }
